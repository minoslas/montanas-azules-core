...
- **Gestor de Paquetes**: Solo se utilizará `pnpm`. La IA debe proporcionar comandos basados en `pnpm` (ej. `pnpm add`, `pnpm run`).
- **Defensa de Cadena de Suministro**: Toda instalación debe omitir scripts maliciosos por defecto.
